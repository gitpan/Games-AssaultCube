# Declare our package
package Games::AssaultCube::Log::Line::FlagReturned;
...
Describes the FlagReturned event in a log line

=head1 DESCRIPTION

This module holds the "FlagReturned" event data from a log line. Normally, you would not use this class directly
but via the L<Games::AssaultCube::Log::Line> class.

This line is emitted when a client returns a flag.
...
The nick of the client who returned the flag
